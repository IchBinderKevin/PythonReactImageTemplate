...
- backend/: Contains the Python backend code. Uses FastAPI as the web framework, and Uvicorn as the ASGI server. Also relies on uv for dependency management. Comes with a small async sqlite database setup as well.
